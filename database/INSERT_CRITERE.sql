...
('Marseille', 'https://example.com/marseille.jpg', 'Vue du Vieux-Port à Marseille', 'Découvrez la ville phocéenne', 'Marseille, la ville phocéenne, est une destination incontournable pour les amateurs de soleil, de mer et de culture. Visitez le Vieux-Port, goûtez à la délicieuse cuisine provençale, et découvrez les calanques environnantes.'),
('Bordeaux', 'https://example.com/bordeaux.jpg', 'Vue de la place de la Bourse à Bordeaux', 'Découvrez la ville du vin', 'Bordeaux, la ville du vin, est une destination de choix pour les amateurs de vin et de gastronomie. Visitez ses célèbres châteaux viticoles, dégustez ses vins fins, et promenez-vous dans ses charmantes rues pavées.'),
('Lyon', 'https://example.com/lyon.jpg', 'Vue de la basilique Notre-Dame de Fourvière à Lyon', 'Découvrez la ville des lumières', 'Lyon, la ville des lumières, est une destination riche en histoire et en culture. Visitez sa célèbre basilique Notre-Dame de Fourvière, goûtez à la délicieuse cuisine lyonnaise, et promenez-vous le long de la Saône.'),
